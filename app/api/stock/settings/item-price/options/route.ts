// app/api/stock/settings/item-price/options/route.ts
...
export async function GET(request: NextRequest) {
  return handleApiRequest<ItemPriceOptions>(
    withEndpointLogging("/api/stock/settings/item-price/options - GET")(
      async () => {
        // Fetch all required options in parallel
        const [priceLists, items, customers, suppliers, uoms] =
          await Promise.all([
